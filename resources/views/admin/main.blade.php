...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('api') }}" class="nav-link">BBC</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ url('api/admin') }}" class="brand-link">
                <span class="brand-text font-weight-light ms-4">Blog post main</span>
            </a>

            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="{{ url('api/admin') }}" class="d-block ms-2">{{ Auth::user()->name }}</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (!Auth::user()->hasRole('author'))
                            <li class="nav-item">
                                <a href="/api/category" class="nav-link">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="/api/post" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Posts
                                </p>
